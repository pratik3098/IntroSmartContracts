...
contract Auction {
    ...
    */
    ...
    // ** Start code here. 2 lines approximately. **/
      if(bidders[tokenDetails[msg.sender].personId].remainingTokens<_count || bidders[tokenDetails[msg.sender].personId].remainingTokens==0 || _itemId > 2)
        {
            revert();
        } 
    ...
    // ** Start code here. 1 line approximately. **
    bidders[tokenDetails[msg.sender].personId].remainingTokens=bidders[tokenDetails[msg.sender].personId].remainingTokens - _count;   
    //** End code here. **
